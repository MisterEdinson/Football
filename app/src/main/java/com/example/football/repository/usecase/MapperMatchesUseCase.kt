...
class MapperMatchesUseCase : MapperMatches<MatchesItem, FootballMatchesDayEntity> {
    override fun mapFromMatchesEntity(entity: MatchesItem?): FootballMatchesDayEntity {
        return FootballMatchesDayEntity(
            id = 0,
            idmatch = entity?.id,
